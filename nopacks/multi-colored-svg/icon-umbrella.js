...
const IconUmbrella = (props) => {
  const umbrellafill = props.umbrellafill || '#000';
...
const DemoIconUmbrella = () => (
  <div>
    <h3>Hello, world!</h3>
    <IconUmbrella />
    <IconUmbrella umbrellafill="orangered"/>
    <IconUmbrella umbrellafill="#ccc"/>
    <IconUmbrella umbrellafill="olive"/>
  </div>
);

export default DemoIconUmbrella;
